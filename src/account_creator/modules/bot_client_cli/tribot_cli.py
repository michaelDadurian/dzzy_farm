...
def find_tribot():
    ...
    #path = "/mnt/c/Users/mdadu/AppData/Roaming/.tribot/dependancies" #move all files from here to ~/.tribot/dependancies
    print("")
...
def use_tribot(charname, charpass, proxy=None):
    ...
    tribot_script = get_settings_variables()[11]
    ...
    client = find_tribot()
    #client = "/mnt/c/Users/mdadu/AppData/Roaming/.tribot/dependancies/TRiBot-10.24.1.jar"
