...
def use_osbot(charname, charpass, proxy=None):
    ...
    osbot_username = get_settings_variables()[15]
    osbot_password = get_settings_variables()[16]
    osbot_script = get_settings_variables()[17]
    script_args = get_settings_variables()[18]
    client = find_osbot()
